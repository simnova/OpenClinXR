...
import { 
  ...
  DIALOGUE_SEED_AUTHORING_PREVIEW_PATH,registerDialogueSeedAuthoringRoutes, } from "./dialogue-seed-authoring-routes.js";
...
async function postPreview(
  ...
  const app = ApiApplication.create()
    .withContext()
    .withCoreMiddleware()
    .withRoutes(registerDialogueSeedAuthoringRoutes)
    .build().app;
