...
export const SIZE_FREEZE: Record<string, { maxLines: number; reason: string }> = {
  ...
  "apps/ui-admin/src/EnvironmentGenerationQueuePanel.tsx": { maxLines: 758, reason: "large admin panel — extract queue sections (HEAD 758; was unfrozen over 600)" },
  ...
  "apps/ui-admin/src/CaseAuthoringWorkbench.tsx": { maxLines: 718, reason: "large authoring panel — extract form sections (HEAD 718)" },
