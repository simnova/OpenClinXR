...
export function buildRepoAgentSpawnPrompt(input: {
  ...
  return [
    ...
    "Confirm AGENTS.md, PROJECT_COORDINATION_INDEX.md, AUTONOMOUS_WORK_PLAN.md, docs/agent-factory/**, agents/**, tools/agent-factory/** exist.",
    `Read ${input.roleDir}/charter.md and ${input.roleDir}/memory.md (tight limit) plus .agent-factory/memory-index.json entries for this role.`,
