...
export type { ApplyStationInteriorLightingForEnvironment, StationRoomContext, StationRoomResult, StationRoomScenarioTheme };

// Direct imports of functions previously passed through context
import { addReusableExteriorPreEncounterRoom as addPackageReusableExteriorPreEncounterRoom, addScenarioSpecificClinicalSetDressing as addPackageScenarioSpecificClinicalSetDressing, loadGeneratedEnvironmentIntoSceneSlot as loadPackageGeneratedEnvironmentIntoSceneSlot } from "@openclinxr/xr-asset-loading";
...
import { loadInfinigenEnvironmentIntoStation, mountStationEnvironmentForRuntime } from "@openclinxr/xr-scene";
