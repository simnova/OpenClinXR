...
import { countActorCommunicationProfiles, formatActorCommunicationProfileCoverage, formatDuration, formatScenarioGovernanceNotice, pluralize, scenarioReviewGateEntries, scenarioStatusColor, reviewGateColor, uniqueValues } from "./index.js";
...
export interface ScenarioBankWorkbenchContextActions {
  // No actions needed for this read-only workbench
}
