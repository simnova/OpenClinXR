...
import type { AdminAssembledExamReviewPacket } from "@openclinxr/review-workflow";
...
export type AdminControlPlaneClient = {
  ...
  getAssembledExamReviewPacket?(input: { examRunId: string }): Promise<AdminAssembledExamReviewPacket>;
