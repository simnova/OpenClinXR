...
import {
  ...
  type FacultyCompileLockClient,
} from "@openclinxr/ui-route-admin";
import { clampedScoreFromInput, formatDuration, pluralize, uniqueValues, ReadinessMetric } from "./index.js";
...
export function ReviewReplayWorkbenchUI(): ReactElement {
  const {
    state: { state, reviewerId, comments, urgentRecognitionScore, teamCommunicationScore, saveState, seedState, stationRunIdInput, stationRunIdParam, examRunIdParam },
