...
export type { CompiledMotionFragment, CompiledMotionTrack, PrimitiveRequest, QuatTuple, TrackProperty, Vec3Tuple } from "./motion-wire-format.js";
export { CLIP_SCHEMA_VERSION, TRACK_PROPERTIES } from "./motion-wire-format.js";

import type { CompiledMotionTrack } from "./motion-wire-format.js";
import { TRACK_PROPERTIES } from "./motion-wire-format.js";
