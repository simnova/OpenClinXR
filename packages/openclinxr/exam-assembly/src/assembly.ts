...
// ---------------------------------------------------------------------------
// Multi-station learner exam form run (additive; single-station still valid)
// blueprint → assembleExamForm → createExamStationRunQueue → station advance
// with form-level clock + per-station ExamRunStationOutcome.
// Claim control: examEquivalenceGate always false; notEvidenceFor always set.
// ---------------------------------------------------------------------------
