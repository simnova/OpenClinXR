...
describe("IWSDK spike plan", () => {
  ...
  it("defines a contained committed sidecar spike sequence before production adoption", () => {
    ...
    expect(sequence.sidecarAppRoot).toBe("apps/arena/ui-xr-iwsdk-spike/");
  ...
  it("blocks IWSDK installs and imports in the advisory policy package", () => {
    expect(evaluateIwsdkWorkspacePosture({
      ...
      dependencies: [
        {
          manifestPath: "packages/openclinxr/arena/iwsdk-spike/package.json",
      ...
      sourceReferences: [
        {
          filePath: "packages/openclinxr/arena/iwsdk-spike/src/accidental.ts",
          packageName: "@iwsdk/xr-input",
        },
      ],
      scriptReferences: [
      ...
      sidecarStatus: "absent_contract_only",
      blockers: [
        "dependency_outside_iwsdk_sidecar:packages/openclinxr/arena/iwsdk-spike/package.json:devDependencies.@iwsdk/core",
        "source_import_outside_iwsdk_sidecar:packages/openclinxr/arena/iwsdk-spike/src/accidental.ts:@iwsdk/xr-input",
  ...
  it("requires operator approval and root package-manager controls when the sidecar exists", () => {
    expect(evaluateIwsdkWorkspacePosture({
      ...
      dependencies: [
        {
          manifestPath: "apps/arena/ui-xr-iwsdk-spike/package.json",
          field: "dependencies",
          name: "@iwsdk/core",
          version: "0.3.1",
        },
  ...
  it("blocks unpinned, review-only, and blocked IWSDK workspace package posture", () => {
    expect(evaluateIwsdkWorkspacePosture({
      ...
      blockers: [
        ...
        "uikitml_spatial_text_package_present_without_operator_approval:apps/arena/ui-xr-iwsdk-spike/package.json:devDependencies.@iwsdk/vite-plugin-uikitml",
        "@iwsdk/core:version_not_exact",
        "@iwsdk/vite-plugin-uikitml:not_allowed_in_first_slice",
        "@iwsdk/reference:blocked_package",
