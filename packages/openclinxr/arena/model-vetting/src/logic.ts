import type {
  ModelVettingGateResult,
  ModelVettingProviderBoundary,
  ModelVettingFalseGates,
  ModelVettingLabModeId,
  ModelVettingLabMode,
  ModelVettingCaptureArtifacts,
  ModelVettingRoleMaterialHandoff,
  ModelVettingRoleAnimationHandoff,
  ModelVettingProceduralFaceDetailHandoff,
