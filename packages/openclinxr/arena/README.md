...
| `physics-touch-contract` | Fixed-step determinism contract (C1–C7) + stub adapter for clinical-touch physics cage match. | [MADR 0021](../../../docs/madr/0021-local-first-no-cloud-implementation-spikes.md), [MADR 0027](../../../docs/madr/0027-quest3-usb-webxr-smoke-gate.md), [MADR 0028](../../../docs/madr/0028-iwsdk-sidecar-spike.md) | Arena-only contract; not production physics. Epic MADR in s6. |
