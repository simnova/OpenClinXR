...
| --- | ---   | ---                                    | ---                      | ---                    | ---                | ---               | ---                    |
| 0   | Scene | openclinxr_canonical_humanoid_armature | -0.54814, 0.02, -0.23361 | 0.54814, 1.905, 0.2375 | 88,428             | 85,870            | 85,870                 |
...
| --- | ---                                       | ---       | ---            | ---          | ---      | ---     | ---                                                  | ---       | ---       |
| 0   | Sphere                                    | TRIANGLES | 1              | 528          | 1,104    | u16     | NORMAL:f32, POSITION:f32, TEXCOORD_0:f32             | 1         | 38.5 KB   |
| 1   | Sphere.001                                | TRIANGLES | 1              | 528          | 1,104    | u16     | NORMAL:f32, POSITION:f32, TEXCOORD_0:f32             | 1         | 38.5 KB   |
| 2   | Sphere.003                                | TRIANGLES | 1              | 528          | 1,104    | u16     | NORMAL:f32, POSITION:f32, TEXCOORD_0:f32             | 1         | 38.5 KB   |
...
| 5   | Sphere.004                                | TRIANGLES | 1              | 528          | 1,104    | u16     | NORMAL:f32, POSITION:f32, TEXCOORD_0:f32             | 1         | 38.5 KB   |
...
| 10  | neutral_generated_human_skinned_mesh_data | TRIANGLES | 3              | 26,692       | 80,062   | u16     | JOINTS_0:u8, NORMAL:f32, POSITION:f32, WEIGHTS_0:f32 | 1         | 3.68 MB   |
