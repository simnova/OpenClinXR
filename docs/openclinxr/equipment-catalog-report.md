...
- measuredAt: 2026-08-12T03:58:35.413Z
- scenarios: 14
- equipment rows: 39
...
- `12_lead_ecg_machine_equipment` recipe=`ecg_cart_midband_v1_pending_merge` — kit on feature/equipment-kit-approach-b — catalogue provisional modular_kit; prose 'medication cart' provisionally mapped to ECG cart class — replace with dedicated recipe
