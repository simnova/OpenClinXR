...
Executable model ownership starts in `packages/openclinxr/data-sources-mongoose-models`. The first model is the scenario-bank control-plane schema with publication indexes and an explicit learner projection that redacts hidden clinical truth.
