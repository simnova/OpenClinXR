...
**Status (2026-08-05):** living **current-reference** how-to — restored from warehouse during status-doc purge because per-worktree turbo cache is a major parallel-agent throughput cost. Not a status ledger.
