...
| `@cellix/archunit-tests` | Aligns with architecture fitness tests. | Do not copy; OpenClinXR already has a native `packages/openclinxr-verification/architecture-rules` package using ArchUnitTS directly. |
