...
| `COMMIT-AUTHORITY.md` | **Standing commit authority:** worktree workers commit+push on green in-lane; promote to main parent-gated; never force-push |
| `TOOLING-TOPOLOGY.md` | **Architect map:** CLI-first surfaces, disabled MCP vs CLI, owners (cross-ref `docs/TOOLING.md`) |
| `DELIVERY-ROLES.md` | **RIF + skill-stub tax:** named domain roles over bare GP write; thin skill stubs vs fat `references/` |
