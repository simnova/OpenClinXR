...
| [`apps/arena/physics-clinical-touch`](../../apps/arena/physics-clinical-touch/README.md) | Deterministic clinical-touch physics cage match shell. | [0021](0021-local-first-no-cloud-implementation-spikes.md), [0027](0027-quest3-usb-webxr-smoke-gate.md), [0028](0028-iwsdk-sidecar-spike.md), [0029](0029-arena-physics-clinical-touch-determinism.md) | Keep outside production XR until successor promotes. |
| [`packages/openclinxr/arena/physics-touch-contract`](../../packages/openclinxr/arena/physics-touch-contract/README.md) | Fixed-step determinism contract (C1–C7) + candidate adapters + physics_config.v1. | [0021](0021-local-first-no-cloud-implementation-spikes.md), [0027](0027-quest3-usb-webxr-smoke-gate.md), [0028](0028-iwsdk-sidecar-spike.md), [0029](0029-arena-physics-clinical-touch-determinism.md) | Arena-only; no production physics import. |
