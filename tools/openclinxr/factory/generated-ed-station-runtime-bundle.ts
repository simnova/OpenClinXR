...
function scenarioRuntimePreset(scenarioId: string): {
  ...
  if (scenario) {
    ...
    return {
      ...
      // #149 — stop emitting the generic cue quartet. Those four boxes were labelled with
      ...
      // reactive props live in runtime-bundles / shipped ED manifests and are untouched here.
      // (#139 closed the empty-roomProps → debug-mode trap; predicate is now reviewStatus only.)
      roomProps: [],
    };
  }
  return {
