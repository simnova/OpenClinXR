/**
 * #139 — generic metadata-labelled cue prop removal inspector.
 *
...
export const GENERIC_CUE_EVIDENCE_DIR = ".openclinxr/evidence/issue-139";
...
/**
 * Classify a declared/live prop as authoring-metadata leakage (#139).
...
async function main(): Promise<void> {
  ...
  if (!writePreFix) {
    await writeGenericCueDump(report, { label: "measure" });
  }
