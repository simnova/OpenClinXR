...
def main() -> int:
    ...
    report = {
        ...
        "mechanism": (
            ...
            "Skin signed distance is negative almost everywhere (max +1.7 mm, still inside the "
            "2 mm coincident band, 0% poking), so the body never protrudes through the closed "
            "skirt. The cargo_pants mesh pokes through the skirt along the skirt outward normal: "
            "max +16.6 mm, 31.9% of thigh-band vertices poking (56% in the worst 3 cm sub-band "
            "at the hem), beige base colour [184,173,140] that matches the pale patches. The "
