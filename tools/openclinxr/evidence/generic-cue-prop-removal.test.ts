 ...
 * ekg-leads-on-bed) restored onto shipped ED manifests so the counterweight is live against the
 * shipped path (they previously existed only in the local fixture / runtime-bundles SSOT).
 * inspectGenericCuePropRemoval() measures declared vs live body meshes. #139 closed the empty
 * roomProps → debug-mode trap before this second attempt.
 */
