        ...
        events: [
          ...
          },
          {
            ...
            payload: {
              textRedacted: true,
              traceContextTags: ["ecg_request"],
              durableEventRef: "durable://station-runs/run_ed_chest_pain_priority_v1_blueprint_voice_simulation_mock_learner/events/4",
            },
          },
          {
            sequence: 5,
            ...
            tag: "history_coverage:ecg_request",
            payload: {
              coveredDomainIds: ["ecg_request"],
              missingDomainIds: [
                "history_opqrst",
              ...
              newlyCoveredDomainIds: ["ecg_request"],
              coveragePercent: 10,
              coverageTraceTags: ["history_coverage:ecg_request"],
          ...
          },
          {
            ...
            payload: {
              ...
              durableEventRef: "durable://station-runs/run_ed_chest_pain_priority_v1_blueprint_voice_simulation_mock_learner/events/6",
            },
          },
        ],
      },
