...
**Last slice (one-liner)**: 2026-06-03 surface caseDerivedVirtualEnvironment in admin (product: env summary in queue panel from factory caseDerived + player three) + player visual props wire (main three for peds/ed) + tech vet (evolution evident/usable per user). See AUTONOMOUS.
