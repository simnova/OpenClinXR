...
**Last slice (one-liner)**: 2026-06-03 gltf container publish (product: gltfEnvContainer + launch policy in player; env world launched/built/tested; + prior; new steering addressed). See AUTONOMOUS.
