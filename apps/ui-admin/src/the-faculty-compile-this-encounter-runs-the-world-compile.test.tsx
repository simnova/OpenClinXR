...
import { EnvironmentGenerationQueuePanel } from "@openclinxr/ui-route-admin/environment-generation-queue-panel";
...
describe("the faculty Compile this encounter runs the world compile", () => {
  ...
  it("(3) COUNTERWEIGHT: FacultyReviewDecisionPanel is not the compile surface", async () => {
    ...
    const src = readFileSync(join(import.meta.dirname, "../../../packages/openclinxr/ui-route-admin/src/faculty-review-decision-panel.tsx"), "utf8");
