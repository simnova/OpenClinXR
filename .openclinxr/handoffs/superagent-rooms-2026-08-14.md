...
**Status:** ready to assign. Patrick asked whether rooms can be offloaded. **Yes — with one blocker
that must be resolved first, stated at the top because it changes what "done" means.**
