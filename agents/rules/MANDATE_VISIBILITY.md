...
- "Do not weaken": this rule lives in orchestration Persona (chief-coordinator/charter ## Persona + `.grok/personas/terse-bluf.toml` tone) + subagent-protocol + spawn prompt builder + agentic-lexicon.md; protected like the 6 files. It now explicitly incorporates sizable collaborative vertical slice requirements.
