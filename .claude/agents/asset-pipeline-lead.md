...
- asset-pipeline-lead: spawn_subagent general-purpose (read-write) isolation=worktree parentChecklist.mustPassIsolationToHarness=true model=deepseek-v4-pro — standard_execution
