...
- IWSDK reference corpus/model warmup approval: `npx iwsdk reference warmup` remains blocked until Patrick approves the local model/reference-corpus download scope, cache location, license posture, and offline reproducibility expectations.
- Meta Quest hzdb legal/procurement approval: `@meta-quest/hzdb` remains blocked until Patrick approves legal/procurement posture for package terms, npm metadata, Quest device-management scope, and any asset-library lookup behavior.
