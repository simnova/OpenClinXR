...
- Quest foreground performance capture: see [proposal-quest-foreground-performance-capture.md](proposal-quest-foreground-performance-capture.md) and `docs/openclinxr/quest-foreground-capture-packet-2026-05-04.md`. USB and ADB authorization are working, the latest refreshed `docs/openclinxr/local-runtime-probe-2026-05-04.json` records `mWakefulness=Awake`, and `docs/openclinxr/quest-cdp-smoke-check-2026-05-04.json` classifies the CDP smoke as `foreground_ready`. Patrick or a human operator still needs to complete the foreground headset performance template before Codex can validate foreground Quest frame pacing, comfort, in-headset text readability, immersive-session comfort, or thermal/battery observations. Do not claim production Quest readiness from browser/CDP/MCP evidence alone.
